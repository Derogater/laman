...
export function ProductGallery({ product }: Props) {
  ...
  // Ensure there's at least one image and selectedImage is within bounds
  const hasImages = product.images && product.images.length > 0;
  const safeSelectedImage = hasImages ? Math.min(selectedImage, product.images.length - 1) : 0;
